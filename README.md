...
You should probably install it within a virtualenv. If you can't run it locally, scroll down for AWS instructions.
...
If you want to get an AWS instance started and get dnsyo up and running quick, here are some commands which should get you up and running within a minute from connecting to your instance.

    curl -O https://raw.github.com/pypa/virtualenv/master/virtualenv.py
    wget https://github.com/pypa/virtualenv/raw/develop/virtualenv_support/pip-1.4.1.tar.gz
    wget https://github.com/pypa/virtualenv/raw/develop/virtualenv_support/setuptools-0.9.8.tar.gz
    python virtualenv.py dnsyo
    . dnsyo/bin/activate
    pip install dnsyo --upgrade
    pip install argparse
    dnsyo www.google.com

Tested with Red Hat Enterprise Linux 6.4 and Amazon Linux AMI.
